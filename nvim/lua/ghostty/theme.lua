...
function M.setup(opts)
  ...
  local colors, new_opts = require("ghostty.colors").setup(opts)
  local groups = require("ghostty.groups").setup(colors, new_opts)
  ...
  if new_opts.terminal_colors then
    M.terminal(colors)
  end

  return colors, groups, new_opts
end
