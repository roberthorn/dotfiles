...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require "ghostty.hsluv"
    if color ~= "NONE" then
...
---@param groups ghostty.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath "cache" .. "/ghostty-default-style-dark-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, ghostty.Cache
